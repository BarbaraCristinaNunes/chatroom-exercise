...
console.log(select.option[select.selectIndex].value)
...
select.addEventListener('click', () => {
    // img.style.backgroundColor = select.option[select.selectIndex].value
})

document.getElementById("btn").addEventListener('click', () => {
    // img.style.backgroundColor = select.value;
    // document.getElementsByClassName('col').innerHTML = select.value;
    console.log("ola");
});